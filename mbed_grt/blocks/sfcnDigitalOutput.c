/*
 *   sfcnDigitalOutput.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        double y1 = dummy(int8 p1,int8 p2, uint8 u1)
 *
 *   Simulink version           : 8.3 (R2014a) 27-Dec-2013
 *   C source code generated on : 18-Feb-2015 09:08:13

 * THIS S-FUNCTION IS GENERATED BY THE LEGACY CODE TOOL AND MODIFIED BY 
 * K.Bass 18.02.2015

 */
#define S_FUNCTION_NAME                sfcnDigitalOutput
